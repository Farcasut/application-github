...
@Unstable
@Named("github")
public class GithubConfigurationSource extends AbstractDocumentConfigurationSource
{

    private static final List<String> SPACE_NAMES = Arrays.asList("Github", "Configs");
    ...
    {
        return "configuration.document.github";
    }
}
